                ...
                <div class="row">
                    <div class="col-md-12">
						<div class="top-row"><!-- 
							...
							<?php $this->renderPartial('/site/_search'); ?>
								...
								<div class="pull-right-block">
                                    <div class="log-block">
                                        ...
                                        if (!Yii::app()->user->isGuest) {
                                            echo CHtml::link('<button id="login-btn"></button>', ['/site/logout']);
                                        }
                                        ?>
                                    </div>                        
                                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <article>
                        <div class="top-logo">
                            <img src="/images/DKB_contact_ADAlogo.png" alt="Asian Directory App Logo">
                        </div>
                    ...
                    <div class="app-links">
                        <a rel="nofollow" target="_blank" href="https://play.google.com/store/apps/details?id=com.appmarket.asiandirectoryapp"><img src="/images/ADA_back_googleplay.jpg" alt="Google Play link"></a>
                        <a rel="nofollow" target="_blank" href="https://itunes.apple.com/gb/app/asian-directory-app/id970097110?mt=8"><img src="/images/ADA_back_appstore.jpg" alt="App Store link"></a>
                        <a rel="nofollow" target="_blank" href="https://www.microsoft.com/en-gb/store/p/asian-directory-app/9nblggh4q8gz"><img src="/images/ADA_back_windows.jpg" alt="Windows Phone link"></a>
                    </div>
                </div>
            </div>
        </div>
...
<!-- FOOTER COPYRIGHT AUTO MSD -->
            ...
            <div class="copyright">
                <span style="color:#949292">2016 - </span><?=  date("Y") ?> &copy; <span style="color:#555">AsianDirectoryApp    |    Website by <a
href=https://www.cloudzion.com/ target=_blank>www.cloudzion.com</a>    |    Hosted On <a
href=https://www.speedzion.net/ target=_blank>www.speedzion.net</a></span>
            </div>
<!-- FOOTER COPYRIGHT AUTO MSD  -->
...
<noscript><img src="https://d5nxst8fruw4z.cloudfront.net/atrk.gif?account=LWDuk1acBb00Gx" style="display:none" height="1" width="1" alt="" /></noscript>
